...
#########################
#path_length is a list of int describing the lenght of all paths in their order occuring in train_files
...
batch_ids_val= [ [] for i in range(maxCount_val) ]
for i in range(len(path_length_val)):
	batch_ids_val[(path_length_val[i])].append(i)
##########################
...
for i in range(TRAIN_STEPS+1):
    train_tupleListList = consumer.get_batch()
    #train step
    model.train_step(train_tupleListList)

...
'''
coronaryOnly=np.genfromtxt('/home/johanna/dl_template/results/newDice/case1_coronaryOnly_useYcTH0.3_SmallVessels/val/metricPerDiameter.csv',delimiter=',')

pretrained= np.genfromtxt('/home/johanna/dl_template/results/newDice/case1_coronaryPretrained_useYc_WORC1TH0.3_SmallVessels/val/metricPerDiameter.csv',delimiter=',')

general=np.genfromtxt('/home/johanna/dl_template/results/newDice/case1_loft_useYc_Contour_WORC1TH0.3_SmallVessels/val/metricPerDiameter.csv',delimiter=',')

#coronaryOnly2=np.genfromtxt('/home/johanna/dl_template/results/newDice/case1_coronaryOnly_useYc/val/metricPerDiameter.csv',delimiter=',')

#pretrained2= np.genfromtxt('/home/johanna/dl_template/results/newDice/case1_coronaryPretrained_useYc/val/metricPerDiameter.csv',delimiter=',')

#general2=np.genfromtxt('/home/johanna/dl_template/results/newDice/case1_loft_useYc_Contour/val/metricPerDiameter.csv',delimiter=',')
...
plt.plot(coronaryOnly[1:-1,9],coronaryOnly[1:-1,12],color='y',linestyle='-',label='coronary only')
#plt.plot(0.26,coronaryOnly[-1,1],'x',color='y')
#plt.plot(coronaryOnly[1:-1,9],np.ones(len(coronaryOnly[1:-1,9]))*coronaryOnly[1,2],color='y',linestyle='-.',label='mean coronary only: {}'.format(round(coronaryOnly[1,2],3)))
#plt.plot(coronaryOnly[1:,9],np.ones(len(coronaryOnly[1:,1]))*sum(coronaryOnly[1:,1])/len(coronaryOnly[1:,1]),color='y',linestyle='-.',label='mean coronary only:{}'.format(round(sum(coronaryOnly[1:,1])/len(coronaryOnly[1:,1]),2)))
plt.plot(pretrained[1:-1,9],pretrained[1:-1,10],color='b',linestyle='-',label='coronary pretrained')
#plt.plot(pretrained[1:-1,9],np.ones(len(pretrained[1:-1,9]))*pretrained[1,2],color='b',linestyle='-.',label='mean coronary pretrained: {}'.format(round(pretrained[1,2],3)))
#plt.plot(0.26,pretrained[-1,1],'+',color='b')
#plt.plot(pretrained[1:,9],np.ones(len(pretrained[1:,1]))*sum(pretrained[1:,1])/len(pretrained[1:,1]),color='b',linestyle='-.',label='mean pretrained:{}'.format(round(sum(pretrained[1:,1])/len(pretrained[1:,1]),2)))
plt.plot(general[1:-1,9],general[1:-1,10],color='r',linestyle='-',label='general')
#plt.plot(general[1:-1,9],np.ones(len(general[1:-1,9]))*general[1,2],color='r',linestyle='-.',label='mean general: {}'.format(round(general[1,2],3)))
#plt.plot(0.26,general[-1,1],'.',color='r')
'''#plt.plot(general[1:,9],np.ones(len(general[1:,1]))*sum(general[1:,1])/len(general[1:,1]),color='r',linestyle='-.',label='mean general:{}'.format(round(sum(general[1:,1])/len(general[1:,1]),2)))
...
plt.savefig('./results/newDice/AssdSmallNormalized',bbox_inches="tight")
plt.show()
...
plt.xlabel('vessel size',fontsize = 12)
plt.plot(coronaryOnly[1:-1,9],coronaryOnly[1:-1,13],color='y',linestyle='-',label='coronary only')
#plt.plot(coronaryOnly[1:-1,9],np.ones(len(coronaryOnly[1:-1,9]))*(coronaryOnly[1,6]),color='y',linestyle='-.',label='mean coronary only: {}'.format(round(coronaryOnly[1,6],3)))
#plt.plot(0.26,coronaryOnly[-1,5],'x',color='y')
...
plt.plot(pretrained[1:-1,9],pretrained[1:-1,11],color='b',linestyle='-',label='coronary pretrained')
#plt.plot(pretrained[1:-1,9],np.ones(len(pretrained[1:-1,9]))*(pretrained[1,6]),color='b',linestyle='-.',label='mean coronary pretrained: {}'.format(round(pretrained[1,6],3)))
#plt.plot(0.26,pretrained[-1,5],'+',color='b')
...
plt.plot(general[1:-1,9],general[1:-1,11],color='r',linestyle='-',label='general')
#plt.plot(general[1:-1,9],np.ones(len(general[1:-1,9]))*(general[1,6]),color='r',linestyle='-.',label='mean general: {}'.format(round(general[1,6],3)))
#plt.plot(0.26,general[-1,5],'.',color='r')
'''
...
plt.legend(bbox_to_anchor=(1.04,0), loc="lower left")
plt.savefig('./results/newDice/HausdorfSmallNormalized',bbox_inches="tight")
plt.show()
'''
#plot Dice
#fig, ax = plt.subplots(figsize=(20,20))
...
plt.xlim([0.06,0.27])
plt.title('Dice(l)')
plt.plot(coronaryOnly[1:-1,9],coronaryOnly[1:-1,3],color='y',linestyle='-',label='coronary only')
plt.plot(coronaryOnly[1:-1,9],np.ones(len(coronaryOnly[1:-1,9]))*coronaryOnly[1,4],color='y',linestyle='-.',label='mean coronary only: {}'.format(round(coronaryOnly[1,4],3)))
plt.plot(0.26,coronaryOnly[-1,3],'x',color='y')
...
plt.plot(pretrained[1:-1,9],pretrained[1:-1,3],color='b',linestyle='-',label='coronary pretrained')
plt.plot(pretrained[1:-1,9],np.ones(len(pretrained[1:-1,9]))*pretrained[1,4],color='b',linestyle='-.',label='mean coronary pretrained: {}'.format(round(pretrained[1,4],3)))
plt.plot(0.26,pretrained[-1,3],'+',color='b')
...
plt.plot(general[1:-1,9],general[1:-1,3],color='r',linestyle='-',label='general')
plt.plot(general[1:-1,9],np.ones(len(general[1:-1,9]))*general[1,4],color='r',linestyle='-.',label='mean general: {}'.format(round(general[1,4],3)))
plt.plot(0.26,general[-1,3],'.',color='r')
...
plt.legend(bbox_to_anchor=(1.04,0), loc="lower left")
plt.savefig('./results/newDice/DiceSmall1',bbox_inches="tight")
plt.show()
